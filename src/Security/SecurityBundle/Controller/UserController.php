...
class UserController extends Controller
{
     ...
     *
     * @Route("/", name="admin_security_user")
     * @Method("GET")
     * @Template()
     */
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_security_user_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/new", name="admin_security_user_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_security_user_show")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_security_user_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_security_user_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="admin_security_user_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_security_user'));
    }
